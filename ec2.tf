...
resource "aws_instance" "bastion" {
  ...
  command = var.list_ec2_configs[count.index].public == true ? "echo The public IP of Bastion is: ${self.public_ip}" : "echo This instance is private and has no public IP"
  }
}
